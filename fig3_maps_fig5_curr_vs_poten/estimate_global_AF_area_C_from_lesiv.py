...
lesiv_area = gpd.read_file('../GEE_shp_output/Lesiv_et_al_national_AF_areas.shp')
...
lesiv_C = gpd.read_file('../GEE_shp_output/Lesiv_et_al_national_AF_C_stocks.shp')

# calculate global AF C, in Pg (incoming data in Mg)
global_C = np.sum(lesiv_C['sum']) / 1e9
print(('\n\nLesiv et al. 2022 data, combined with WHRC global AGB map, '
